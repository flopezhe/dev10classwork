...
public class App {
    public static void main(String[] args) {
        List<Category> categories = List.of(
                new Category(13, 4, "Timpani"),
                new Category(1, 0, "Orchestra"),
                new Category(2, 1, "Brass"),
                new Category(8, 5, "Cellos"),
                new Category(13, 4, "Snare Drums"),
                new Category(3, 1, "Woodwinds"),
                new Category(13, 3, "Oboes"),
                new Category(4, 1, "Percussion"),
                new Category(13, 2, "French Horns"),
                ...
                new Category(13, 3, "Bassoons"),
                new Category(12, 2, "Tubas"),
                new Category(13, 3, "Flutes"),
                new Category(13, 3, "Clarinets"),
