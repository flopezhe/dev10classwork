...
public class BoardGame {
    ...
    private List<BoardGamePublisher> publishers = new ArrayList<>();
    ...
    public List<BoardGamePublisher> getPublishers() {
        return new ArrayList<>(publishers);
    }

    public void setPublishers(List<BoardGamePublisher> publishers) {
